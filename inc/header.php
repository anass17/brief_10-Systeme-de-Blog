    ...
    <div class="max-w-[1250px] mx-auto px-3 h-16 flex justify-between items-center">
        ...
        <?php else: ?>
            ...
            <div class="*:ml-7 *:font-semibold text-white flex items-center">
                ...
                <div class="relative">
                    <button class="block w-9 h-9 rounded-full overflow-hidden border-2 border-white user-menu">
                        <img src="<?php echo $user -> getImageUrl(); ?>" alt>
                    </button>
                    <div class="absolute hidden right-0 z-30 -bottom-5 translate-y-full w-60 rounded bg-white shadow-md border text-gray-700">
                        <div class="rounded-full w-14 h-14 block mx-auto mt-5 border-orange-500 overflow-hidden border-2">
                            <img src="<?php echo $user -> getImageUrl(); ?>">
                        </div>
                        <h3 class="text-center font-semibold text-lg pt-3"><?php echo $user -> getFirstName(); ?> <?php echo $user -> getLastName(); ?></h3>
                        <?php if(isset($user) && $user -> getRole() == "admin"): ?>
                            <h4 class="text-gray-500 font-normal text-center text-sm">Admin</h4>
                        <?php endif; ?>
                        <div class="h-px w-20 bg-gray-200 mx-auto my-3"></div>
                        <div>
                            <div class="py-2">
                            ...
                            <a href="/pages/logout.php" class="block py-2 px-5 border-t">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
